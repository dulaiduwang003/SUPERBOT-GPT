...
import CompareImageComponent from "../../../components/compareImageComponent.vue";
...
<template>
  <view class="card" v-for="(item,index) in workflowsData" :key="index" @click="">
    <view class="card-image">
      <CompareImageComponent :width="'680'" :height="'600'" :beforeImageUrl="item.originalImage"
    ...
    <view class="cardText">
      ...
      <view class="cardTextBox">
        ...
        <view class="btn" @click="toPage('/pages/drawing/view/drawingDetailsView?workflowsId='+item.workflowsId)">
          快速生成
        </view>
      </view>
    </view>
