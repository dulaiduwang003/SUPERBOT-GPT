...
public final class RedisUtils {
    ...
    public Object listPop(final String key, final int count, final TimeUnit unit) {
        return redisTemplate.opsForList().rightPop(key, count, unit);
    ...
    public Long keySetSize(final String key) {
